...
(function ($) {
    ...
    $.fn.SumoSelect = function (options) {
        ...
        var settings = $.extend({
            placeholder: '请选择',   // Dont change it here.
            csvDispCount: 3,              // display no. of items in multiselect. 0 to display all.
            captionFormat:'{0} 已选中', // format of caption text. you can set your locale.
            captionFormatAllSelected:'{0} 全部选中!', // format of caption text when all elements are selected. set null to use captionFormat. It will not work if there are disabled elements in select.
            ...
            searchText: '搜索...',      // placeholder for search input
            noMatch: '没找到匹配： "{0}"',
