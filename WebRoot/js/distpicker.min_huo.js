...
!function (t) {
	...
	e.prototype = {constructor:e, init:function () {
		...
		}), n || (p.length && (d.autoSelect || d.autoselect) && (p[0].selected = !0), !this.active && h && (u[e] = h)), d.placeholder && p.unshift({code:"", address:u[e], selected:!1}), a.html(this.getList(p)));
		d.autoSelect = !0;
	}, getList:function (i) {
		var e = [];
	...
	}}, e.DEFAULTS = {autoSelect:!0, placeholder:!0, province:"\u2014\u2014 \u7701 \u2014\u2014", city:"\u2014\u2014 \u5e02 \u2014\u2014", district:"—— 不限制区/县 ——"}, e.setDefaults = function (i) {
