                    ...
                    <div class="ibox-content">
                    	<form method="post" class="form-horizontal" id="actStatistics_add" >
	                      ...
	                      <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                	<input onclick="WdatePicker()" type="text" name="startTime" value="${entity.startTime }" readonly="readonly" class="form-control"  class="Wdate" size="12">
                                </div>
                           </div>
	                      <div class="form-group">
                                <label class="col-sm-2 control-label">活动开始时间</label>
                                <div class="col-sm-10">
                                	<input onclick="WdatePicker()" type="text" name="endTime" value="${entity.endTime }" readonly="readonly" class="form-control"  class="Wdate" size="12">
                                </div>
                           </div>
	                       	<div>
								<button class="btn btn-primary" type="button" id="add_content">修改</button>
