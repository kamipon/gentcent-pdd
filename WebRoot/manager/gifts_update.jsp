                    ...
                    <div class="ibox-content">
	                    <form method="post" class="form-horizontal" >
	                        <div class="form-group">
	                            ...
	                            <div class="col-sm-10">
	                                <input type="text" class="form-control" name="name" value = "${gifts.name}">
	                            </div>
	                        </div>
	                        <div class="form-group">
	                            ...
	                            <div class="col-sm-2">
                                	...
                                	<img src="${gifts.imgUrl }" name="imgUrl" id="picUrl" style="height:50px;">
                                </div>
	                        </div>
	                        <div class="form-group">
	                            <label class="col-sm-2 control-label"><font color="red">*</font>价值</label>
	                            <div class="col-sm-10">
	                                <input type="text" class="form-control" name="price" value = "${gifts.price}">
	                            </div>
	                        </div>
	                        <div class="form-group">
	                            <label class="col-sm-2 control-label"><font color="red">*</font>库存</label>
	                            <div class="col-sm-10">
	                                <input type="text" class="form-control" name="inventory" value = "${gifts.inventory}">
	                            </div>
	                        </div>
	                        <div class="form-group">
	                            <label class="col-sm-2 control-label">商家编码</label>
	                            <div class="col-sm-10">
	                            	<input type="text" class="form-control" name="outid" value = "${gifts.outid}">
	                            </div>
	                        </div>
	                        <div class="form-group">
	                            <label class="col-sm-2 control-label">兑换数量</label>
	                            <div class="col-sm-10">
	                            	<input type="text" class="form-control" name="volume" value = "${gifts.volume}">
	                            </div>
	                        </div>
	                        <div class="form-group">
	                            <label class="col-sm-2 control-label">排序</label>
	                            <div class="col-sm-10">
	                            	<input type="text" class="form-control" name="order" value = "${gifts.order}">
	                            </div>
	                        </div>
	                        <div class="form-group">
	                            <label class="col-sm-2 control-label"><font color="red">*</font>兑换所需积分</label>
	                            <div class="col-sm-10">
	                            	<input type="text" class="form-control" name="integral" value = "${gifts.integral}">
	                            </div>
	                        </div>
	                         <div class="form-group">
	                            <label class="col-sm-2 control-label">描述</label>
	                            <div class="col-sm-10">
	                            	<textarea maxlength="255" name="desc" id="desc" rows="3" cols="70" style="width:800px;height:400px;visibility:hidden;" >${gifts.desc}</textarea>
	                            </div>
	                        </div>
                        	<div>
                                  <button class="btn btn-primary" type="button" id="update_gifts">修改</button>
