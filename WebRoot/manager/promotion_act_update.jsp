                    	...
                    	<form method="post" class="form-horizontal" id="promotion">
	                        ...
	                        <div class="form-group">
	                            ...
	                            <div class="col-sm-2">
                                	...
                                	<img  src="${item.img }"  name="picUrl" id="shareUrl" style="height:50px;width: 50px">
                                </div>
	                        </div> 
	                        <div class="form-group">
	                            ...
	                            <div class="col-sm-10">
	                                <select class="form-control" name="type" id="type" >
	                                	<option value="0" <c:if test="${item.type==0 }">selected="selected"</c:if>>现金</option>
	                                	<option value="1" <c:if test="${item.type==1 }">selected="selected"</c:if>>优惠券</option>
	                                	<option value="2" <c:if test="${item.type==2 }">selected="selected"</c:if>>实物</option>
	                                	<option value="3" <c:if test="${item.type==3 }">selected="selected"</c:if>>积分</option>
	                                	<option value="4" <c:if test="${item.type==4 }">selected="selected"</c:if>>大转盘</option>
	                                </select>
	                            </div>
	                        </div>
	                        <div class="form-group">
	                            ...
	                            <div class="col-sm-10">
	                                <input type="text" class="form-control" name="startcode" value="${item.startcode }">
	                            </div>
	                        </div>
	                        <div class="form-group">
	                            <label class="col-sm-2 control-label"><font color="red">*</font>结束号</label>
	                            <div class="col-sm-10">
	                                <input type="text" class="form-control" name="endcode" value="${item.endcode }">
	                            </div>
	                        </div>
	                        <div class="form-group">
	                            ...
	                            <div class="col-sm-10">
	                            	<select name="xcx" class="form-control m-b">
	                            		...
	                            		<c:forEach items="${list}" var="each">
	                            			<option value="${each.id }" <c:if test="${each.id==item.xcx }">selected=selected</c:if>>${each.modelName }</option>
	                            		</c:forEach>
	                            	</select>
	                            </div>
	                        </div>
	                         <div class="form-group" style="margin-top: 5px">
	                            ...
	                            <div class="col-sm-10">
	                                <input value="1" type="radio" <c:if test="${item.isOpen==1 }">checked="checked"</c:if>  name="isOpen">是&nbsp;&nbsp;&nbsp;&nbsp;
	                                <input value="0" type="radio" <c:if test="${item.isOpen==0}">checked="checked"</c:if> name="isOpen" >否
	                            </div>
	                        </div>
	                        <div  id="sheng" class="form-group" style="margin-top: 5px">
	                            ...
	                            <div class="col-sm-10">
	                                ...
	                                <input value="0" type="radio" <c:if test="${item.isSheng==0 }">checked="checked"</c:if> name="isSheng" onchange="shengshi()">否
	                            </div>
	                        </div>
	                        <div id="shi" class="form-group" style="margin-top: 5px">
	                            ...
	                            <div class="col-sm-10">
	                                ...
	                                <input value="0" type="radio" <c:if test="${item.isShi==0 }">checked="checked"</c:if> name="isShi" onchange="shengshi()" >否
	                            </div>
	                        </div>
...
$(document).ready(function() {
	...
	$(function(){
		$("#add_activity").click(function(){
			...
			//是否限制省
			var isSheng= $('input[name="isSheng"]:checked ').val();
			//是否限制市
			var isShi= $('input[name="isShi"]:checked ').val();
				//省
