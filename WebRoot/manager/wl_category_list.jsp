	...
	<script type="text/javascript">
		...
		function ajaxContentList(param) {
			$.ajax({
				async:false,
				cache:false,
				url:"${cp }/wlcategory/ajax/"+param.navId,
				type:"post",
				dataType:"json",
				error:function(data){
					layer.msg("请求失败");
		...
		$("#add_fath_article").click(function(){
		   layer.open({
		      ...
		      shade: 0.8,
		      area: ['1200px', '90%'],
		      content: '${cp }/wlcategory/toadd' //iframe的url
		   });
		 });
	</script>
</head>
											...
											<form method="get" class="form-horizontal" id="modularForm">
												...
												<div class="form-group">
													...
													<div class="col-sm-10">
														...
														<img src="" id="picUrl" name="picUrl" style="height: 50px;width: 50px;">
													</div>
												</div>
												<div class="form-group">
													<label class="col-sm-2 control-label">
...
<script type="text/javascript">
	...
	$("#add_son_article").click(function(){
		...
		var idVal = nodes[0].id;
		  layer.open({
			  ...
			  shade: 0.8,
			  area: ['1200px', '90%'],
			  content: '${cp }/wlcategory/toadd?parentId='+idVal //iframe的url
		});			
	});
	...
	function choose(){
	   layer.open({
			...
			shade: 0.8,
			area: ['800px', '90%'],
			content: '${cp }/manager/wl_category_choose.jsp' //iframe的url
	   });
	}
