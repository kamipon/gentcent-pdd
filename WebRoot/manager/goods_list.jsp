                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            ...
                            <a class="J_menuItem"  onclick="add()">实物添加</a>
                        </div>                     
                    </div>
							...
							<form action="${pageContext.request.contextPath }/goods" method="get">
								...
								<div class="col-sm-6">
									<div class="dataTables_length" id="DataTables_Table_0_filter">
											<label>
												查找：
					                        	<input type="text"   name="title" placeholder="根据实物标题查询">
		                        ...
		                        <tbody>
		                            <tr>
		                                <td align="center" class="pn-sp">
		                                    <form id="paging" action="${pageContext.request.contextPath }/goods" method="get">
