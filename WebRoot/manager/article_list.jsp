                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            ...
                            <a class="J_menuItem" href="manager/article_add.jsp">文章添加</a>
                        </div>
                    </div>
                    ...
                    <div class="ibox-content">
						<div id="DataTables_Table_0_wrapper" class="dataTables_wrapper form-inline" article="grid">
							<form action="${pageContext.request.contextPath }/article" method="get">
								<div class="row">
									<div class="col-sm-6">
	                            ...
	                            <tbody  id="idsVal">
	                            	<c:forEach items="${list}" var="items">
	                            		<tr>
		                            		...
		                            		<td>
		                            			<a href="<%=basePath%>article/info/${items.id}"><%=basePath%>article/info/${items.id}</a>
		                            		</td>
		                            		<td>
			                            		${items.addTime }
		                            		</td>
		                            		<td>
				                                ...
				                                <a class="J_menuItem" href="article/${items.id}" >修改</a>
		                            		</td>
	                            		</tr>
	                            	</c:forEach>
	                            </tbody>
		    	...
		    	if(isConfirm){
		    		$.ajax({
						...
						success:function(data){
							if(data.flag){
								swal({title:"删除成功！", text:"您已经永久删除了这条文章。", type:"success"},function(){
