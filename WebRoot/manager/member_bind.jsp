...
<body class="gray-bg">
				...
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						<div id="DataTables_Table_0_wrapper" class="dataTables_wrapper form-inline" role="grid">
							<form action="${pageContext.request.contextPath }/member/bind/tobind" method="get">
								<div class="row">
									<div class="col-sm-6">
										<div class="dataTables_length" id="DataTables_Table_0_filter">
											<label>
												<div class="dataTables_length" id="DataTables_Table_0_filter">
													<label>
													昵称:
							                        	<input value="${nick }" name="nick" id="nick" type="text" class="form-control" style="width: 20%">&nbsp;
													shotID:
							                        	<input value="${shotId }" name="shotId" id="shotId" type="text" class="form-control" style="width: 20%">&nbsp;
							                        	<input type="submit" style="margin-top: 5px" class="btn btn-outline btn-info" value="搜索"> 
							...
							<c:forEach items="${list}" var="items">
								<tr>
									...
									<td>
										...
										<c:choose>
											<c:when test="${items.disable==0 || empty items.disable}">
							...
							<tbody>
								<tr>
									<td align="center" class="pn-sp">
										<form id="paging" action="${pageContext.request.contextPath }/member/bind" method="get">
	...
	function account(){
   		layer.open({
			...
			shade: 0.8,
			area: ['800px', '50%'],
			content: 'wxmodel_sms/binding'  //iframe的url
		});
   	}
	//通知设置
   	function check(mbId){
