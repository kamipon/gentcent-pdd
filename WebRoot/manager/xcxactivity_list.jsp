                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            ...
                            <a class="J_menuItem" href="manager/xcxactivity_add.jsp">模板添加</a>
                        </div>                     
                    </div>
	                      ...
	                      <table class="table table-striped table-bordered table-hover dataTables-example" id="editable" style="table-layout:fixed">
	                            ...
	                            <tbody  id="idsVal">
	                            	<c:forEach items="${list}" var="items">
	                            		<tr>
		                            		<td>
		                            			<a class="J_menuItem" href="xcxActivity/query?id=${items.id}">${items.modelName }</a>
		                            		</td>
		                            		<td>
		                        ...
		                        <tbody>
		                            <tr>
		                                <td align="center" class="pn-sp">
		                                    <form id="paging" action="xcxActivity" method="get">
