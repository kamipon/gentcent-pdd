    ...
    <script type="text/javascript" src="manager/js/kindeditor-min.js"></script>
    	...
    	function ajaxFileUpload1(obj) {
	     ...
	     window.onload=function(){
			var y=Number(${fxzGoods.vertical});
			var x=Number(${fxzGoods.level});
			$("#p").css("top",y+"px");
			$("#p").css("left",x+"px");
		 	$("#t").find("option[value='"+${fxzGoods.vertical}+"']").attr("selected",true);
		 	 $("#l").find("option[value='"+${fxzGoods.level}+"']").attr("selected",true);
		 }
                    	...
                    	<form method="post" class="form-horizontal" >
                    		<div class="form-group">
	                            ...
	                            <div class="col-sm-2">
									...
									<img  src="${fxzGoods.picUrl }" id="1" style="width: 100%;height: 100%;margin-top: -21%">
	                            </li>
                                </div>
	                        </div>
	                        <div class="form-group">
	                            ...
	                            <div class="col-sm-10">
	                                <input type="text" class="form-control" name="name" value="${fxzGoods.name }">
	                            </div>
	                        </div>
	                        <div class="form-group">
	                            <label class="col-sm-2 control-label"><font color="red">*</font>分享内容</label>
	                            <div class="col-sm-10">
	                                <input type="text" class="form-control" name="content" value="${fxzGoods.content }">
	                                <br>
	                        ...
	                        <div class="form-group">
	                            ...
	                            <div class="col-sm-10">
	                                <input type="text" style="width: 60%" class="form-control" value="${fxzGoods.music }" id="music" name="music" disabled="disabled">
	                        ...
	                        <div class="form-group">
	                            ...
	                            <div class="col-sm-10">
	                                <input type="color" name="color" value="${fxzGoods.color}" style="width: 30px;height: 30px">
	                            </div>
	                            <img src="./images/bk.png" style="margin-left: 20%;margin-top: -4.7%" >
	                        </div>
	                        <div class="form-group">
	                            <label class="col-sm-2 control-label"><font color="red">*</font>分享背景图片</label>
	                            <div class="col-sm-2">
                                	<li class="fileinput-button js-add-image" >
                                	<a class="fileinput-button-icon show_update_imgs" href="javascript:;">+</a>
	                            ...
	                            <div id="2" style="width: 300px;height: 500px;position: relative;background-image:url('${fxzGoods.picture }') ; background-repeat:no-repeat; background-size:100% 100%;-moz-background-size:100% 100%;} ">
	                            		<img src="${fxzGoods.picture }" style="display: none" id="i2">
	                            	<div id="p" style="width: 100px;height: 100px;background-color: white;position: absolute;left: 256px;top:220px;text-align: center;line-height: 100px;border: 1px solid red;">二维码</div>
	                            </div>
	                            </div>
                                </div>
	                        </div>
	                        <div class="form-group">
	                            ...
	                            <div class="col-sm-10">
	                                <input type="text" class="form-control" name="payfont" value="${fxzGoods.payfont}">
	                            </div>
	                        </div>
	                        <div class="form-group">
	                            <label class="col-sm-2 control-label"><font color="red">*</font>底部分享按钮内容</label>
	                            <div class="col-sm-10">
	                                <input type="text" class="form-control" name="sharefont" value="${fxzGoods.sharefont}">
	                            </div>
	                        </div>
	                        <div class="form-group">
	                        	<label class="col-sm-2 control-label"></label>
	                        ...
	                        <div class="form-group">
	                            ...
	                            <div class="col-sm-10">
					                                否 <input type="radio"  name="isHx" value="1"  <c:if test="${fxzGoods.isHx==1}">checked="checked"</c:if>> &nbsp;&nbsp;
					                                是 <input type="radio"  name="isHx" value="0" <c:if test="${fxzGoods.isHx==0}">checked="checked"</c:if>>
	                        ...
	                        <div class="form-group">
	                            ...
	                            <div class="col-sm-10">
					                                否 <input type="radio"  name="isAddress" value="0" <c:if test="${fxzGoods.isAddress==0}">checked="checked"</c:if> > &nbsp;&nbsp;
					                                是 <input type="radio"  name="isAddress" value="1" <c:if test="${fxzGoods.isAddress==1}">checked="checked"</c:if> >
	                        ...
	                        <div class="form-group">
	                            ...
	                            <div class="col-sm-10">
					                                否 <input type="radio"  name="isTrueman" value="0" <c:if test="${fxzGoods.isTrueman==0}">checked="checked"</c:if> > &nbsp;&nbsp;
					                                是 <input type="radio"  name="isTrueman" value="1" <c:if test="${fxzGoods.isTrueman==1}">checked="checked"</c:if> >
	                        ...
	                        <div class="form-group" id="truepay" style="display: none">
	                            ...
	                            <div class="col-sm-10">
	                                <input type="text" class="form-control" name="truemanPay" value="${fxzGoods.truemanPay}" onkeyup="this.value=(this.value.match(/\d+(\\d{0,0})?/)||[&#39;&#39;])[0]">
	                            </div>
	                        </div>
	                        <div class="form-group" id="trueopen" style="display: none">
	                            <label class="col-sm-2 control-label"><font color="red">*</font>虚拟参与人数</label>
	                            <div class="col-sm-10">
	                                <input type="text" class="form-control" name="truemanOpen" value="${fxzGoods.truemanOpen}" onkeyup="this.value=(this.value.match(/\d+(\\d{0,0})?/)||[&#39;&#39;])[0]">
	                            </div>
	                        </div>
	                        <div class="form-group">
	                            <label class="col-sm-2 control-label"><font color="red">*</font>联系方式</label>
	                            <div class="col-sm-10">
	                                <input type="text" class="form-control" name="telphone" id="telphone" value="${fxzGoods.telphone }" onkeyup="this.value=(this.value.match(/\d+(\.\d{0,0})?/)||[&#39;&#39;])[0]">
	                            </div>
	                        </div>
	                        <div class="form-group">
	                            <label class="col-sm-2 control-label"><font color="red">*</font>价格</label>
	                            <div class="col-sm-10">
	                                <input type="text" class="form-control" name="price" id="price" value="${fxzGoods.price }" onkeyup="this.value=(this.value.match(/\d+(\.\d{0,2})?/)||[&#39;&#39;])[0]">
	                            </div>
	                        </div>
	                        ...
	                        <div class="form-group">
	                            ...
	                            <div class="col-sm-10">
	                                <input type="text" class="form-control" name="money" id="money" value="${fxzGoods.money }" onkeyup="this.value=(this.value.match(/\d+(\.\d{0,2})?/)||[&#39;&#39;])[0]">
	                            	 <font color="red">佣金可以为0 , 但不能小于0.3. 不能大于价格的60%.
	                           		</font>
	                            </div>
	                        </div>
	                        <div class="form-group">
	                            ...
	                            <div class="col-sm-10">
	                                <input type="text" class="form-control" name="num" id="num" value="${fxzGoods.num }" onkeyup="this.value=(this.value.match(/\d+(\.\d{0,0})?/)||[&#39;&#39;])[0]">
	                            <font color="red">当前账户余额：<fmt:formatNumber pattern="0.00" value="${yue+money}" maxFractionDigits="2"/>元<br>
	                                              ...
	                                              此次商品总佣金(金额*数量)设置不可超过 <fmt:formatNumber pattern="0.00" value="${yue+money+fxzGoods.num*fxzGoods.money}" maxFractionDigits="2"/>(账户余额+创建当前活动时冻结的佣金)元
	                            </font>
	                            </div>
	                        </div>
	                       <div class="form-group">
	                            ...
	                            <div class="col-sm-10">
	                                <input id="endTime" type="text" name="endTime" readonly="readonly" class="form-control" onClick="WdatePicker()"  size="12" value="<fmt:formatDate type="both" value="${fxzGoods.endTime}" />"/>
	                            </div>
	                        </div>
	                        <div class="form-group">
	                            <label class="col-sm-2 control-label">商品描述</label>
	                            <div class="col-sm-10">
	                            	<textarea maxlength="255" name="desc" id="desc" rows="3" cols="70" style="width:800px;height:400px;visibility:hidden;">${fxzGoods.desc }</textarea>
	                            </div>
	                        </div>
                          	<div class="form-group">
	                            <label class="col-sm-2 control-label">活动规则</label>
	                            <div class="col-sm-10">
	                                <textarea maxlength="255" name="desc2" id="desc2" rows="3" cols="70" style="width:800px;height:400px;visibility:hidden;">${fxzGoods.desc2 } </textarea>
	                            </div>
	                        </div>
	                       	<div>
...
<script type="text/javascript">
	$(function(){
		...
		radio.change(function(){
	  	...
	  	var radioVal =$('input[name="isTrueman"]:checked');
	  	if(radioVal=='0'){
			$("#truepay").css("display","none");
			$("#trueopen").css("display","none");
		}else{
		...
		$("#add_activity").click(function(){
			...
			var id="${fxzGoods.id}";
			var addTime="${fxzGoods.addTime} ";
			var activity="${fxzGoods.activity} ";
			var flag = validate(
				name,"请输入商品名称!",
				price,"请输入价格,且价格不能为0",
				money,"请输入佣金",
		...
		function validate(date1,msg1,date2,msg2,date3,msg3,date4,msg4,date5,msg5,date7,msg7,date8,msg8,msg9,msg10,date11,msg11,date12,msg12,date13,msg13,date14,msg14,date15,msg15){
			var lowestPrice = $("#lowestPrice").val();
			var price = $("#price").val();
			var yue=${yue+money};
			var money=${fxzGoods.num*fxzGoods.money};
			if(date1 == ''){
				layer.msg(msg1);
				return false;
