                ...
                <div class="ibox float-e-margins">
                   ...
                   <div class="ibox-content">
						<div id="DataTables_Table_0_wrapper" class="dataTables_wrapper form-inline" >
							<form action="redpacket/coupon_red" method="post" >
								...
								<div class="row" style="width: 100%;height:40px">
	                           	    <div id="money" style="margin-top: -7px;margin-left: 10px;position: relative;width:48%;height: 50px" class="col-sm-5">
	                           	     ...
	                           	     <div class="col-sm-3" style="margin-left: 42%;margin-top:-35px;width: 48%" id="sear"> 
										<div class="dataTables_length" id="DataTables_Table_0_filter" >
											<label>
												查找：
					                        	<input type="text"  name="redMoney" placeholder="根据优惠券金额查询">
...
<script>
		...
		function query(){
			...
			window.location.href="redpacket/list?money="+money+"&&code="+code+"&&type=1&&noUse="+noUse;
		}
		...
		function exportExcel(){
			...
			var id=$.trim($("input[name='id']").val());
		        ...
		        closeOnConfirm: false
		   		 ...
		   		 if(isConfirm){
		    		window.location.href="redpacket/actexport?start="+start+"&end="+end+"&id="+id+"&type=1";
		...
		function exportZip(){
			...
			var id=$.trim($("input[name='id']").val());
		        ...
		        closeOnConfirm: false
		   		 ...
		   		 if(isConfirm){
		    		window.location.href="zip/downloadActivity?start="+start+"&end="+end+"&id="+id+"&type=1";
