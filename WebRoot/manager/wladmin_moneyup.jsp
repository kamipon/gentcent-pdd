                    ...
                    <div class="ibox-content">
	                    <form method="post" action="wechart" class="form-horizontal" id="wechartForm">
	                        <div class="form-group">
	                            <label class="col-sm-2 control-label">定金上限：</label>
	                            <div class="col-sm-10">
	                                <input type="text" class="form-control" name="moneyup" value="${loginUser.moneyup }">
	                            </div>
	                        </div>
...
<script >
	$(function(){
		$("#add").click(function(){
			var moneyup = $.trim($("input[name='moneyup']").val());
				$.ajax({
					url:"wladmin/moneyup",
					type:"post",
					dataType:"json",
