                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
						<div id="DataTables_Table_0_wrapper" class="dataTables_wrapper form-inline" role="grid">
							<form action="${pageContext.request.contextPath }/note/recorder" method="get">
								<div class="row">
								<div class="col-sm-6">
	                            ...
	                            <tbody  id="idsVal">
	                            	<c:forEach items="${list}" var="items">
	                            		<tr>
		                            		...
		                            		<td>
		                            			<c:if test="${items.type==1}">普通</c:if>
		                            			<c:if test="${items.type==2}">核销</c:if>
		                            		</td>
	                            			<td>
		                            			${items.phone}
		                            		</td>
		                        ...
		                        <tbody>
		                            <tr>
		                                <td align="center" class="pn-sp">
		                                    <form id="paging" action="${pageContext.request.contextPath }/note/recorder" method="get">
