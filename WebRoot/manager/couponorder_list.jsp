                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
						<div id="DataTables_Table_0_wrapper" class="dataTables_wrapper form-inline" role="grid">
							<form action="${pageContext.request.contextPath }/couponRecord" method="get">
								<div class="row">
									<div class="col-sm-6">
		                        ...
		                        <tbody>
		                            <tr>
		                                <td align="center" class="pn-sp">
		                                    <form id="paging" action="${pageContext.request.contextPath }/couponRecord" method="get">
