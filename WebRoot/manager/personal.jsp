                        ...
                        <form method="post" class="form-horizontal" id="terForm">
                        	...
                        	<div class="form-group">
                                ...
                                <div class="col-sm-2">
                                	...
                                	<img src="${user.picUrl }" name="picUrl" id="picUrl" style="height:50px;">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div>
	                             <button class="btn btn-primary" type="button" id="add_ter">保存内容</button>
