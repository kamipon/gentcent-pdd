	                    ...
	                    <form method="post" class="form-horizontal" >
	                        <div class="form-group">
	                         ...
	                         <div class="form-group">
	                            ...
	                            <div class="col-sm-10">
	                            	<textarea maxlength="255" name="content" id="content" rows="3" cols="70" style="width:800px;height:400px;visibility:hidden;"></textarea>
	                            </div>
	                        </div>
                        	<div>
                                  <button class="btn btn-primary" type="button" id="add_article">新增</button>
