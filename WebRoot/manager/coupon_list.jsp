                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            ...
                            <a class="J_menuItem"  onclick="add()">优惠券添加</a>
                        </div>                     
                    </div>
							...
							<form action="${pageContext.request.contextPath }/coupon" method="get">
								...
								<div class="col-sm-6">
									<div class="dataTables_length" id="DataTables_Table_0_filter">
											<label>
												查找：
					                        	<input type="text"   name="title" placeholder="根据优惠券标题查询">
		                        ...
		                        <tbody>
		                            <tr>
		                                <td align="center" class="pn-sp">
		                                    <form id="paging" action="${pageContext.request.contextPath }/coupon" method="get">
    ...
    <script type="text/javascript">
	    function add(){
			 	layer.open({
					...
					shade: 0.8,
					area: ['1500px', '90%'],
					content: 'manager/coupon_add.jsp',
					end:function(){
							location.reload();
						}
			});		
