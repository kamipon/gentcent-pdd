                   ...
                   <div class="ibox-content">
	                    <form method="post" class="form-horizontal" >
	                        ...
	                        <div class="form-group">
	                            ...
	                            <div class="col-sm-10">
	                                <input type="text" class="form-control" name="zfb" value="${activity.zfb }">
	                            </div>
	                        </div>
	                        <div class="form-group">
	                            <label class="col-sm-2 control-label"><font color="red">*</font>支付宝账号姓名</label>
	                            <div class="col-sm-10">
	                                <input type="text" class="form-control" name="zfbname" value="${activity.zfbname }">
	                            </div>
	                        </div>
	                        <div class="form-group">
	                            <label class="col-sm-2 control-label"><font color="red">*</font>用户密码</label>
	                            <div class="col-sm-10">
	                                <input type="text" class="form-control" name="password" value="${activity.user.password }">
	                            </div>
	                        </div>
	                        <!-- 
	                        <div class="form-group">
