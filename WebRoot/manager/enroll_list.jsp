                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
						<div id="DataTables_Table_0_wrapper" class="dataTables_wrapper form-inline" role="grid">
							<form action="${pageContext.request.contextPath }/enroll/list" method="get">
								<div class="row">
									<div class="col-sm-6">
	                      ...
	                      <table class="table table-striped table-bordered table-hover dataTables-example" id="editable" style="table-layout:fixed">
	                            ...
	                            <c:forEach items="${list}" var="items">
		                            		...
		                            		<c:if test="${sessionScope.loginUser.id ne '1'}">
		                            		<td>
		                                		<a class="J_menuItem" onclick="update('${items.id}','${items.desc}')"">修改备注</a>
		                        ...
		                        <tbody>
		                            <tr>
		                                <td align="center" class="pn-sp">
		                                    <form id="paging" action="enroll/list" method="get">
				...
				inputValue:desc,
					...
					$.ajax({
						...
						success:function(data){
							if(data.flag){
								swal({title:"修改备注成功！",type:"success"},function(){
