...
var url3="${xcx.pic3}";
var la="${xcx.latitude}";
var lng="${xcx.longitude}";
var geocoder,map,marker = null;
var init = function() {
    var center = new qq.maps.LatLng(parseFloat(la),parseFloat(lng));
                    ...
                    <div class="ibox-content">
                    	<form method="post" class="form-horizontal" >
	                        <div class="form-group">
	                            ...
	                            <div class="col-sm-10">
	                                <input type="text" class="form-control" name="modelName" value="${xcx.modelName }">
	                            </div>
	                        </div>
	                         <div class="form-group">
	                            ...
	                            <li class="fileinput-button js-add-image" style="left: 16px"  onclick="ch(1)">
									...
									<img  id="1" style="width: 100%;height: 100%;margin-top: -21%" src="${xcx.pic1 }">
	                            </li>
	                            <li class="fileinput-button js-add-image" style="margin-top: -80px;margin-left: 24%" onclick="ch(2)">
									...
									<img  id="2" style="width: 100%;height: 100%;margin-top: -21%" src="${xcx.pic2 }">
	                            </li>
	                            <li class="fileinput-button js-add-image" style="margin-top: -80px;margin-left: 30.5%" onclick="ch(3)">
									...
									<img  id="3" style="width: 100%;height: 100%;margin-top: -21%" src="${xcx.pic3 }">
	                            </li>
	                        ...
	                        <div class="form-group">
	                            ...
	                            <div class="col-sm-10">
	                                <input type="text" class="form-control" name="name" value="${xcx.name }">
	                            </div>
	                        </div>
	                         <div class="form-group">
	                            <label class="col-sm-2 control-label"><font color="red">*</font>商家电话</label>
	                            <div class="col-sm-10">
	                                <input type="text" class="form-control" name="phone" value="${xcx.phone }">
	                            </div>
	                        </div>
	                         <div class="form-group">
	                            <label class="col-sm-2 control-label"><font color="red">*</font>地址</label>
	                            <div class="col-sm-4" style="height: 25px">
	                                <input type="text" class="form-control" name="address" id="address" placeholder="如：武汉市黄鹤楼" value="${xcx.address }">
	                      ...
	                      <div class="form-group" style="margin-top: 25px">
	                            ...
	                            <div class="col-sm-10">
	                            	<textarea maxlength="255" name="content" id="desc" rows="3" cols="70" style="width:100%;height:400px;visibility:hidden;">${xcx.desc }</textarea>
	                            </div>
	                        </div>
	                       	<div>
								<button class="btn btn-primary" type="button" id="add_content" onclick="add()">修改</button>
