                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
						...
						<div class="ibox-tools">
							...
							<a class="J_menuItem" href="manager/reply_default_add.jsp">添加</a>
						</div>
                    </div>
		                        ...
		                        <tbody>
		                            <tr>
		                                <td align="center" class="pn-sp">
		                                    <form id="paging" action="${pageContext.request.contextPath }/reply/default" method="get">
